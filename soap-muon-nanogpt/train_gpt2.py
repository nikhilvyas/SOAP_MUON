...
if master_process:
    ...
    wandb.init(project="soap-muon-nanogpt", config=args, entity="harvardml")
...
if args.optimizer_name == 'muon':
    ...
    optimizer1 = DistributedSOAP([{'params': raw_model.transformer.h.parameters(), 'lr': args.learning_rate}, 
                                  ...
                                  decoupled_weight_decay=args.weight_decay, precondition_frequency=args.precondition_frequency, step_delay=args.step_delay, use_pf_warmup=args.use_pf_warmup,
                                  distributed_config=DDPShampooConfig(),
                                  shampoo_pt2_compile_config=ShampooPT2CompileConfig())
    optimizers = [optimizer1]
elif args.optimizer_name == 'soap_muon':
    optimizer1 = SOAP_Muon([{'params': raw_model.transformer.h.parameters(), 'lr': args.learning_rate}, 
                            {'params': raw_model.lm_head.weight, 'lr': args.lr_lm_head if args.lr_lm_head else args.learning_rate},
                            {'params': raw_model.transformer.wte.weight, 'lr': args.lr_wte if args.lr_wte else args.learning_rate}],
                            ...
                            muon_power=args.muon_power, newton_schulz_steps=args.newton_schulz_steps)
    optimizers = [optimizer1]
else:
